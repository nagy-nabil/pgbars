...
use windows::{
    ...
    Win32::{
        ...
        System::{Com::*, Ole::VariantInit, TaskScheduler::*},
    },
};
...
fn main() -> Result<(), Error> {
    unsafe {
        ...
        let task_name = BSTR::from(r"My Task");
        ...
        let time_trigger = trigger.cast::<ITimeTrigger>()?;
        time_trigger.SetId(&BSTR::from(r"Trigger1"))?;

        time_trigger.SetEndBoundary(&BSTR::from(r"2024-05-02T08:00:00"))?;

        //  Set the task to start at a certain time. The time
        //  format should be YYYY-MM-DDTHH:MM:SS(+-)(timezone).
        //  For example, the start boundary below
        //  is January 1st 2005 at 12:05
        time_trigger.SetStartBoundary(&BSTR::from(r"2005-01-01T12:05:00"))?;
        ...
        let reged_tasl = folder.RegisterTaskDefinition(
            &task_name,
            &task,
            6,
            VariantInit(),
